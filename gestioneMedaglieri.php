...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/gestioneMedalglieri.css">
                ...
                <div class="col-md-4 justify-content-center">
                    ...
                    <form action="" method="post">
                        <div class="card">
                            <div class="card-body">
                                <p>Titolo</p>
                                <input type="text" class="flexible-input titolo" id="selectedItemTitoloInput" name="selectedItemTitoloInput">
