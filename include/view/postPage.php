                ...
                <article>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-md-1">
                              <button id="loveButton" class="love-button bi-suit-heart" data-utenteID="<?= $post['utenteId']; ?>" data-dataOra="<?= $post['dataOra']; ?>">
                                  <!-- Icona del cuore vuota -->
                                  <svg id="emptyHeart" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-suit-heart" viewBox="0 0 16 16">
                                  ...
                                  <svg id="filledHeart" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-suit-heart-fill" viewBox="0 0 16 16" style="display: none;">
