                ...
                <article>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br/>
                            <div class="row">
                                <p>Questo post ha x riflessioni, <span class="like-count"><?= $post['counterMiPiace']; ?></span> mi piace e <?= $post['counterAdoro']; ?> adoro</p>
                            </div>
                            <div class="row">
                              <div class="col-md-1">
                            ...
                            <div class="col-md-1">
                              <button id="loveButton" class="love-button bi-suit-heart" data-utenteID="<?= $post['utenteId']; ?>" data-dataOra="<?= $post['dataOra']; ?>">
                                  ...
                                  <svg id="filledHeart" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-suit-heart-fill" viewBox="0 0 16 16">
