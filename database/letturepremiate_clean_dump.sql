...
CREATE TABLE `post` (
  ...
  `counterMiPiace` int(8) NOT NULL,
  `counterAdoro` int(8) NOT NULL,
  `libroId` int(8) NOT NULL,
...
INSERT INTO `utente` VALUES (7,'admin','admin@tecweb.it','$2y$10$3OlMvmQbXDETNgS8Mqdi6.nIi0ZRT88H0ud2JHL4hWZ3tC1VJcn12','65a25733abf6d_root.jpg',1,'System Admin',0);
...
-- Dump completed on 2024-02-06  0:12:03
